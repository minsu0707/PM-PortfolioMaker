  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background to-background/95 py-12">
      <div className="max-w-4xl mx-auto px-4">
        <h1 className="text-4xl font-bold text-foreground mb-4">{t("nav.about") || "About"}</h1>
        <p className="text-muted-foreground text-lg mb-12">
          {t("about.description") || "Learn more about PortfolioMaker"}
        </p>

        {/* Mission Section */}
        <div className="bg-card rounded-lg border border-border p-8 mb-8">
          <h2 className="text-2xl font-bold text-foreground mb-4">{t("about.mission") || "Our Mission"}</h2>
          <p className="text-muted-foreground mb-6">
            {t("about.missionDesc") || "We help professionals create stunning portfolios effortlessly."}
          </p>

          <h3 className="text-xl font-bold text-foreground mb-4">{t("about.features") || "Key Features"}</h3>
        ...
        <div className="bg-card rounded-lg border border-border p-8">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-lg font-semibold text-foreground mb-2">민수 최 (Minsu Choi)</h3>
